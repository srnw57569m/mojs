...
**Added**
- `DanceFloorsManager` for defining rectangular zones where users automatically get random emotes looped on them while inside, with movement-based auto-detection
